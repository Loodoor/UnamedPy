...
class ComputerManager:
    def __init__(self, ecran, police, render_manager, max_size=PC_MAX_CREA):
        self.ecran = ecran
        self.police = police
        self.storage = []
        ...
        self._btn_creatures = ree.load_image(os.path.join("..", "assets", "gui", "fd_bouton_poche_creatures.png"))
        self._btn_to_creatures = ree.load_image(os.path.join("..", "assets", "gui", "fd_bouton_to_poche_creatures.png"))
