...
class PolygonAttributes(object):
    def __init__(self, gptr, index):
        ...
        ckresult(_dll.FMOD_Geometry_GetPolygonAttributes(self._ptr, self.index, byref(self._directocclusion),
                                                         byref(self._reverbocclusion), byref(self._doublesided)))
    ...
    def direct_occlusion(self, occ):
        ckresult(_dll.FMOD_Geometry_SetPolygonAttributes(self._gptr, self.index, occ, self._reverbocclusion,
                                                         self._doublesided))
    ...
    def reverb_occlusion(self, occ):
        ckresult(_dll.FMOD_Geometry_SetPolygonAttributes(self._gptr, self.index, self._directocclusion, occ,
                                                         self._doublesided))
...
class Geometry(FmodObject):
    def add_polygon(self, directocclusion, reverbocclusion, doublesided, *vertices):
        ...
        varray = va(*vertices)
        idx = c_int()
        self._call_fmod("FMOD_Geometry_AddPolyGon", directocclusion, reverbocclusion, doublesided, len(vertices),
                        byref(varray), byref(idx))
        return idx.value
