...
from constantes import DEBUG_LEVEL, rendering_engine, POL_ANTIALISING
...
def onscreen_debug(ecran, font, *debug_infos, **kwargs):
    if DEBUG_LEVEL >= 2:
        ...
        if size_y == -1:
            rendering_engine.draw_rect(ecran, (start_x, start_y, line_width, len(debug_infos) * line_height), (128, 128, 128))
        else:
            rendering_engine.draw_rect(ecran, (start_x, start_y, line_width, size_y), (128, 128, 128))
